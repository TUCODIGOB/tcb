...
//
// QUE SE GUARDA: solo texto. Los rasgos, las siete areas y sus datos, y la
// carta natal con la que se hicieron. Unas pocas decenas de KB por informe.
...
export async function guardarInforme({ producto, sessionId, cliente, carta, areas, rasgos }) {
  const cfg = ajustes();
  if (!cfg) {
