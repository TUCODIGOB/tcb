...
export function revisarBloques(bloques, opciones) {
  ...
  // escenaOpcional lo pone quien ya ha decidido a proposito entregar el area
  // sin escena. Sin ese aviso explicito, la escena sigue siendo obligatoria.
  if (!(opciones && opciones.escenaOpcional) && cuantos('escena') < 1) {
