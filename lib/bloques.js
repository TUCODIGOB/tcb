...
export function montarArea(datos) {
  ...
  //
  // Vale para las cuatro, la escena incluida: tampoco un ejemplo se lee bien
  // pegado al final, que corta el area justo antes del golpe.
  ...
  for (const item of pedidos) {
    ...
    if (ocupados.has(n)) {
      ...
      // Si no queda ni un hueco libre se resigna a compartir parrafo, que ya es
      // un area que no da de si: hacen falta cinco parrafos para las cuatro
      // casillas y una de verdad trae once o mas. Lo que no hace nunca es
      // usar el ultimo, que ahi el cierre se queda sin su linea de texto.
    }
    ocupados.add(n);
