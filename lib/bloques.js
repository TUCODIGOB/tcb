...
export function revisarBloques(bloques, opciones) {
  ...
  // de que un area con una sola frase en negrita en novecientas palabras no se
  // ha destacado, y en el informe que se genero de verdad pasaba eso. Se
  ...
  if (negritas < 3) {
    fallos.push(`solo hay ${negritas} frases en negrita y el área se lee sin nada que destaque: va en negrita todo lo que sacude, que en un área de estas siempre es más de una cosa`);
  }
