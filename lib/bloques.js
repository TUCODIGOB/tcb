...
export function analizarArea(texto) {
  ...
  // segun la regla: se marca el golpe, no el parrafo.
  {
    ...
    const desmarcar = (bloque, trozo) => {
      // El texto que se devuelve va en una funcion: en el segundo argumento de
      // replace, un "$&" o un "$1" dentro del trozo se leerian como patron y
      // el parrafo saldria corrompido. Con la funcion sale lo que hay.
