...
(function () {
  ...
  function showBanner() {
    ...
    banner.style.cssText =
      ...
      "background:#0e3f4b;color:#fffbef;padding:1.1rem 1.2rem;" +
      "display:flex;flex-wrap:wrap;gap:.9rem;align-items:center;justify-content:center;" +
      "font-family:'Open Sans',sans-serif;font-size:.92rem;line-height:1.5;" +
      "box-shadow:0 -4px 24px rgba(0,0,0,.2);";

    banner.innerHTML =
      '<p style="margin:0;max-width:640px;flex:1 1 320px;">' +
