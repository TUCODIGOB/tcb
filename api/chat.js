...
- PALABRAS DE MANUAL, PROHIBIDAS DEL TODO. Estas y todas sus variantes no se escriben nunca, ni una sola vez: mecanismo, procesamiento, procesar, registrar, ajuste, ajustar, desestabilizar, dinámica, estructura, funcionamiento, configuración, activar, desplegar, canalizar, integrar, tensión interna, parte de ti, tu sistema. Son las palabras de quien mira desde fuera, no las de quien le habla. Si te sale una, no la cambies por otra parecida: di lo que hace la persona, con un verbo de andar por casa.
