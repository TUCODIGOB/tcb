...
- VAN REPARTIDAS POR TODA EL ÁREA, de principio a fin, y ninguna en las fortalezas, que ahí no hay nada que preguntarse. Cada vez que acabas de contarle algo que le remueve, te paras y le preguntas: la pregunta sale justo de eso que le acabas de decir y le devuelve la pelota, le hace pararse y mirarse a ella en concreto, no pensar en general. No hay un numero fijo, van las que pida el texto. CADA PREGUNTA VA SOLA EN SU PROPIO PÁRRAFO, nunca metida dentro de otro. NUNCA DOS SEGUIDAS: entre una pregunta y la siguiente va contado entero aquello de lo que sale la segunda. Y NINGUNA ANTES DEL CIERRE: delante del cierre no va una pregunta, y el cierre no es una pregunta.
- UNA O DOS FRASES DE CADA ÁREA VAN MARCADAS. Son las que más golpean de todo lo que has escrito ahí, las que ella subrayaría si tuviera un lápiz: una verdad suya dicha de una forma que no se había dicho nunca. No es un resumen ni un titular ni una frase bonita: es una frase del texto que por sí sola le hace pararse. Van SOLAS EN SU PROPIO PÁRRAFO y entre dobles asteriscos, asi: **la frase**. Nunca pegadas a una pregunta, nunca dos seguidas, y nunca justo antes del cierre.
