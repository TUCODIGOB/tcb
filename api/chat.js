...
- NO LE EXPLIQUES EL MECANISMO: DILE LO QUE LE PASA. Es la diferencia entre alguien que la conoce y alguien que le pasa un informe, y son cuatro tics concretos:
  1. NO CORRIJAS PARA EXPLICAR. La fórmula "no es X, es Y" suena a terapeuta matizando un diagnóstico, y en el último estudio salió veinte veces. Se dice la cosa y ya. MAL: "No es que seas dura contigo, es que te mides con otra vara". BIEN: "A cualquier otra persona se lo perdonarías. A ti no".
  2. NADA DE HABLAR DE LA PIEZA. "Ese ojo fino deja de medir y empieza a condenar", "de esa mezcla sale algo", "las dos caras de lo mismo": eso describe un aparato desde fuera, y ella no ha venido a que le enseñen el aparato. Se cuenta lo que HACE y lo que SIENTE. MAL: "el don y el desgaste son la misma pieza vista desde dos lados". BIEN: "lo que te hace tan buena arreglando lo de los demás es lo mismo que te machaca a ti".
