...
- PON EN NEGRITA COMO SUBRAYARÍA UN LECTOR CON UN ROTULADOR EN LA MANO. Va leyendo y, cada vez que una frase le sacude, la marca. No lleva la cuenta, no las reparte por la página y no se guarda ninguna para más adelante: marca todas las que le sacuden, y si en un área hay ocho que lo merecen, marca las ocho. Tú haces lo mismo, poniendo la frase en negrita con dos asteriscos a cada lado: **así**.
- QUÉ VA EN NEGRITA: lo que le pone nombre a algo que lleva años sintiendo sin saber decirlo; lo que la retrata haciendo algo que creía que no se le notaba; lo que le escuece porque no lo puede negar; y también lo que la deja bien parada de una manera que no esperaba. La prueba es física: si al leerla en voz alta te paras un segundo, va en negrita.
- QUÉ NO: lo que solo explica o informa, y lo que ya se veía venir dos líneas antes. Se marca la frase entera o media frase, nunca una palabra suelta y nunca un concepto. Y de un contraste se marca la mitad que duele, no las dos, que marcar las dos se lee a plantilla.
- SI DUDAS, MÁRCALA. Un área con siete frases en negrita se lee bien y se recuerda. Un área con una sola parece que no tenía nada que decir, y ese es el fallo que hay que evitar: quedarse corto hace más daño que pasarse.
...
3. Has puesto en **negrita** todo lo que sacude, no una sola cosa. Relee el area: si solo hay una frase en negrita, te has quedado corta y faltan
...
Si lo que faltan son negritas: pon en negrita, con dos asteriscos a cada lado (**asi**), las frases del texto corrido que sacuden, las que le ponen nombre a algo que llevaba años sintiendo sin saber decirlo, las que la retratan, las que le escuecen porque no las puede negar. Todas las que lo merezcan, no una cuenta. Se marca la frase entera o media frase, nunca una palabra suelta. Dentro de la escena, del remate, de la pregunta y del cierre NO se marca nada. Poner los asteriscos no cambia ni una palabra, que es la regla de arriba.
