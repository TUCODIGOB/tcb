...
// ─── EL LUGAR ────────────────────────────────────────────────────────────────
//
// COPIADO DEL P1, TAL CUAL. Es el mismo codigo que hoy comprueba el lugar en
// la pagina de "tu-diseno-de-origen": no vale con que el mapa conteste algo,
// tiene que contestar de verdad lo que se ha escrito. Y cuando no cuadra, dice
// CUAL de los tres campos esta mal, para poder marcarlo en rojo.
//
// Aqui corre en el servidor en vez de en el navegador, que es la unica
// diferencia.
