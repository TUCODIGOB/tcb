...
SUBTÍTULOS — el área lleva TRES subtítulos cortos repartidos por dentro, ni uno más ni uno menos, y se cuentan antes de entregar: si no son tres, el área no está terminada. Van repartidos, no amontonados, y cada uno va solo en su párrafo y empieza por "## ", la marca, un espacio y ya la primera palabra del subtítulo. No lleva punto al final.
...
[C] — POR QUÉ ES ASÍ, con puente causal explícito hasta lo que hace hoy. Es el porqué de SUS DESAFÍOS, de dónde le nacen, y solo de ellos. No basta con decir que le pasa: tienes que unir causa y efecto para que entienda el PORQUÉ y no solo el qué. Qué hay dentro de la persona que le produce eso, qué le pasa por dentro en el momento en que le ocurre y qué hace hoy exactamente por ser así.
